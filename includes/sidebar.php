...
$profile_picture = isset($profile['profile_picture']) && !empty($profile['profile_picture']) 
    ...
    : 'default.png';
?>
<aside id="sidebar" class="w-64 min-h-screen fixed top-20 left-0 lg:translate-x-0 -translate-x-full transition-transform duration-300 z-30 flex flex-col pb-20">
    ...
    <nav class="flex-grow overflow-y-auto relative h-full">
