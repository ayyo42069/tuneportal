    ...
    <div class="flex-1 mt-16 ml-64 p-8">
        ...
        <div class="mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-8">
                ...
                <?php
                // Fetch notifications using a prepared statement
                ...
                <div class="space-y-2">
                    ...
                    <div class="p-3 border rounded <?= $note['is_read'] ? 'bg-gray-50' : 'bg-blue-50' ?>">
                        <p class="text-sm">
                            ...
                            <?php if ($note['link']): ?>
                            <a href="<?= htmlspecialchars($note['link']) ?>" class="text-red-600 hover:text-red-800 ml-2">
                                View →</a>
                            <?php endif; ?>
                        </p>
                        ...
                        <div>
                            ...
                            ?>
                                <label class="block mb-2">
                                    ...
                                    <?= htmlspecialchars($opt['name']) ?> (<?= $opt['credit_cost'] ?> credits)
                                </label>
                            <?php endwhile; ?>
                        </div>
                        <div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            <?php
                            // Fetch files using a prepared statement
                            ...
                            ?>
                                <tr class="border-b">
                                    <td class="p-2"><?= htmlspecialchars($file['title']) ?></td>
                                    <td class="p-2"><?= htmlspecialchars($file['car_model']) ?></td>
                                    <td class="p-2">
                                        <span class="px-2 py-1 rounded <?= $file['status'] === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800' ?>">
                                            <?= ucfirst($file['status']) ?>
                                        </span>
                                    </td>
                                    <td class="p-2">v<?= htmlspecialchars($file['current_version']) ?></td>
                                    <td class="p-2">
                                        <a href="file_details.php?id=<?= htmlspecialchars($file['id']) ?>" class="text-red-600 hover:text-red-800">View</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
