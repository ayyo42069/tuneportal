        ...
        <div class="container mx-auto px-4 py-8 mt-16">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800">Credit Balance</h3>
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">Welcome Back, <?= htmlspecialchars($_SESSION['username']) ?>!</h2>
...
$stmt = $conn->prepare("SELECT * FROM notifications WHERE user_id = ? OR user_id IS NULL ORDER BY created_at DESC LIMIT 5");
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="p-4 border rounded-lg <?= $note['is_read'] ? 'bg-gray-50' : 'bg-blue-50 border-blue-100' ?>">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <form action="upload.php" method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Tuning Options</label>
                                    <div class="space-y-2 max-h-40 overflow-y-auto p-2">
                                        ...
                                        <label class="flex items-center space-x-2">
                                            ...
                                            <span class="text-sm text-gray-700">
                                                ...
                                                <span class="text-gray-500">(<?= $opt['credit_cost'] ?> credits)</span>
                                            </span>
                                        </label>
                                        <?php endwhile; ?>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Select .bin File</label>
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-red-500 transition-colors">
                                        <div class="space-y-1 text-center">
                                            ...
                                            <p class="text-xs text-gray-500">.bin files only</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
